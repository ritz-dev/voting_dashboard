...
const classes = {
    ...
    dashed:
      'border border-border-400 border-dashed bg-transparent hover:text-light hover:bg-accent hover:border-accent',
    disabled:
    ...
    disabledDashed: 'border border-dashed border-border-base text-muted cursor-not-allowed',
...
const LinkButton:React.FC<NextLinkProps & ButtonProps> = ({
    ...
    const rootClassName = cn(
        classes.root,
        {
            ...
            [classes.dashed]: !disabled && variant === 'dashed',
            [classes.disabledDashed]: disabled && variant === 'outline',
